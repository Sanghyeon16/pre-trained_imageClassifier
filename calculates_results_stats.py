...
#                                                                             
# PROGRAMMER: Sanghyeon Lee
# DATE CREATED:  Sep. 21 2022                                  
# REVISED DATE: 
...
def calculates_results_stats(results_dic):
    ...
    for data in results_dic.values():
        results_stats_dic['n_dogs_img'] += data[3]
        results_stats_dic['n_notdogs_img'] += 1 if data[3]==0 else 0
        results_stats_dic['n_match'] += data[2]
        results_stats_dic['n_correct_dogs'] += 1 if data[3] and data[4] else 0
        results_stats_dic['n_correct_notdogs'] += 1 if (data[3]==0) and (data[4]==0) else 0
        results_stats_dic['n_correct_breed'] += 1 if data[2] and data[3] else 0
